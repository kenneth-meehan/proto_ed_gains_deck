...
author: "Ken Meehan"
date: "Report Date: April 11, 2018"
output: 
  pdf_document:
...
#Set distict to report upon. Ultimaely, this choice would be incorporated into SQL query of remote database.
district <- "Broward Co School District"
#district <- "Charlotte-mecklenburg Sch Dist"
...
```{r readZips, eval=TRUE, echo=FALSE, cache=FALSE}
setwd("data")
